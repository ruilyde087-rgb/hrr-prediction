...
A hybrid architecture combining:
    ...
    - MLP regressor with Sigmoid output
...
class FinalPatentModel(nn.Module):
    ...
    normalized HRR value via an MLP regressor with Sigmoid activation.
    ...
    Output:
        - predictions: HRR values [batch], range (0, 1) via Sigmoid.
    """
    ...
    def forward(
        ...
        Returns:
            Predicted HRR values [batch], range (0, 1).
        """
