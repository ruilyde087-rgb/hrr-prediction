...
A de-identified sample dataset from one participant is provided for demonstration purposes, including filtered heart rate belt recordings and IMU sensor data.

| File | Description |
|------|-------------|
| `sample_hr_imu.csv` | Filtered heart rate belt and IMU data from one representative subject |

> **Note**: This sample dataset has been filtered and anonymized. All personally identifiable information has been removed.

## K2P Twin Platform Demonstrations
...
| Phase | Description |
|-------|-------------|
| Sprint Bout | First high-intensity sprint phase |
| Inter-Bout Recovery | Recovery interval between sprint bouts |
| Cool-Down | Post-exercise recovery phase |

<table>
  <tr>
    <td align="center">
      <video src="./demos/demo_sprint.mp4" width="100%" controls></video><br/>
      <b>Sprint Bout</b><br/>
      <sub>First high-intensity sprint phase of HIIT</sub>
    </td>
    <td align="center">
      <video src="./demos/demo_recovery.mp4" width="100%" controls></video><br/>
      <b>Inter-Bout Recovery</b><br/>
      <sub>Recovery interval between sprint bouts</sub>
    </td>
    <td align="center">
      <video src="./demos/demo_cooldown.mp4" width="100%" controls></video><br/>
      <b>Cool-Down</b><br/>
      <sub>Post-exercise recovery phase</sub>
    </td>
  </tr>
</table>
